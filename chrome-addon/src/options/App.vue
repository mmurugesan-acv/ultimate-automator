...
<template>
  <div class="min-h-screen bg-background text-foreground pt-6 pl-20 pr-20">
    <!-- Loading Screen -->
    <div v-show="isLoading" class="fixed inset-0 flex items-center justify-center z-50" style="background: linear-gradient(135deg, #282c34 0%, #1e2127 100%);">
      ...
      <div class="text-center relative z-10">
        ...
        <div class="relative mb-8">
          <!-- Outer Ring -->
          <div class="w-24 h-24 rounded-full border-4 border-transparent border-t-blue-500 border-r-purple-500 animate-spin mx-auto"></div>
          <!-- Inner Ring -->
          <div class="absolute top-2 left-2 w-20 h-20 rounded-full border-4 border-transparent border-b-green-400 border-l-yellow-400 animate-spin" style="animation-direction: reverse; animation-duration: 1.5s;"></div>
          <!-- Center Dot -->
        ...
        <!-- Animated Text -->
        <div class="mb-6">
          <h2 class="text-2xl font-bold mb-2 bg-gradient-to-r from-blue-400 via-purple-500 to-green-400 bg-clip-text text-transparent animate-pulse">
        ...
        <div class="w-64 h-2 bg-gray-700 rounded-full mx-auto overflow-hidden">
          <div class="h-full bg-gradient-to-r from-blue-500 via-purple-500 to-green-400 rounded-full loading-progress"></div>
        </div>
